...
Route::prefix('anggota')->middleware(['role:anggota'])->group(function () {
    ...
    Route::post('/arsipkan/{upload}', [AnggotaController::class, 'arsipkan'])->name('anggota.arsipkan');
    Route::post('/arsip/{arsip}/hapus', [AnggotaController::class, 'hapusArsip'])->name('anggota.arsip.hapus');
});
...
Route::prefix('admin')->middleware(['admin'])->group(function () {
    ...
    Route::post('/capaian/reset', [CapaianController::class, 'reset'])->name('admin.capaian.reset');
    Route::post('/capaian/delete-file', [CapaianController::class, 'deleteFile'])->name('admin.capaian.delete.file');
    ...
    Route::post('/users/{user}/delete', [ManajemenUserController::class, 'destroy'])->name('admin.users.destroy');

    // Upload Anggota (admin lihat)
    Route::get('/upload-anggota', [UploadAnggotaController::class, 'index'])->name('admin.upload.index');
    Route::post('/upload-anggota/{upload}/arsipkan', [UploadAnggotaController::class, 'arsipkan'])->name('admin.upload.arsipkan');
    Route::post('/upload-anggota/{upload}/delete', [UploadAnggotaController::class, 'destroy'])->name('admin.upload.destroy');
});
...
Route::prefix('admin')->middleware(['role:super_admin,admin_divisi,admin_bidang'])->group(function () {
    ...
    Route::post('/folder-dokumen/{folder}/delete', [FolderDokumenController::class, 'destroy'])->name('admin.folder.destroy');
    ...
    Route::post('/anggota/{user}/toggle', [KelolaAnggotaController::class, 'toggleActive'])->name('admin.anggota.toggle');
    Route::post('/anggota/{user}/delete', [KelolaAnggotaController::class, 'destroy'])->name('admin.anggota.destroy');
});
