...
<style>
    ...
    /* ===== TOOL GRID (upload) ===== */
    .tool-grid { display: grid; grid-template-columns: 1fr; gap: 24px; max-width: 640px; margin: 0 auto; }
    .tool-card {
    ...
    @media (max-width: 768px) {
        ...
        .folder-tree details > summary .count { display: none; }
        .tree-upload-list li { flex-wrap: wrap; gap: 6px; }
        .tree-upload-list li .file-actions { width: 100%; justify-content: flex-end; }
        ...
        .file-table td {
            ...
            padding: 7px 0; border-bottom: 1px dashed #eef2f7; white-space: normal;
        }
        .file-table td:last-child { border-bottom: none; }
        .file-table td::before {
            content: attr(data-label);
            font-size: 11px; font-weight: 600; text-transform: uppercase;
            letter-spacing: 0.4px; color: #64748b; flex-shrink: 0;
        }
        .file-table td.text-right { text-align: left; justify-content: flex-end; }
        .file-table td.text-right::before { display: none; }
        .file-table .btn { white-space: nowrap; }
    }
...
<section class="arsip-section">
    <div class="container">
        <div class="section-header">
            ...
            <p class="subtitle">Temukan berkas di struktur folder di bawah, atau simpan dokumen baru ke folder bidang Anda</p>
        </div>
                                ...
                                <div class="tree-child">
                                    ...
                                    <table class="file-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td data-label="Nama File">{{ $up->judul }}</td>
                                                <td data-label="Jenis">{{ strtoupper($up->file_type) }}</td>
                                                <td data-label="Tanggal Unggah">{{ \Carbon\Carbon::parse($up->tanggal_upload)->format('d/m/Y') }}</td>
                                                <td data-label="Ukuran">{{ $up->ukuran }}</td>
                                                <td class="text-right">
                                                    @if($up->dapat_dipreview)
